...
public enum Viewport {
  FIXED_CLASSIC_LAYOUT(WidgetInfo.FIXED_VIEWPORT),
  RESIZABLE_CLASSIC_LAYOUT(WidgetInfo.RESIZABLE_VIEWPORT_OLD_SCHOOL_BOX),
  RESIZABLE_MODERN_LAYOUT(WidgetInfo.RESIZABLE_VIEWPORT_BOTTOM_LINE);
